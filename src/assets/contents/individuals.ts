            ...
            sections: [
                {
                    ...
                    paragraphes: [
                        {
                            text:  `En cas d’accident de la vie ou de maladie, vous aurez peut être besoin d’un fauteuil roulant,
            ...
            sections: [
                {
                    ...
                    paragraphes: [
                        {
                            text: `Vous êtes en convalescence ou en invalidité permanente, il est important de choisir
                            le fauteuil roulant le mieux adapté à votre morphologie et à vos besoins.
                            La maniabilité d’un fauteuil roulant est primordiale.
                            Nous sélectionnons pour vous des fauteuils faciles à pousser ou à  manœuvrer,
                            aussi bien à l’intérieur qu’à l’extérieur. Du fauteuil de transfert au fauteuil roulant  manuel
                            chacun adapté au mieux a votre morphologie et à votre pathologie.`,
                        },
                        {
                ...
                },
                {
                    ...
                    paragraphes: [
                        {
                            text: `Le scooter, pour les PMR et les personnes âgées et est une solution
                            idéale pour se déplacer sans effort lors de trajets de courte et moyenne distance.
                            Vous pouvez ainsi aller au travail, faire vos courses ou partir en promenade en toute autonomie.
                            Le modèle choisi dépend de votre morphologie, du lieu d’utilisation,
                ...
                },
                {
                    ...
                    paragraphes: [
                        {
                            text: `Les cannes et béquilles sécurisent le déplacement d’une personne présentant
                            des troubles de la marche et de l’équilibre, Elles peuvent aussi diminuer ou éliminer
                            la charge sur une blessure.`
                        },
                        {
                            text: `Notre sélection de cannes de marche, de cannes anglaises ou de béquilles axillaires
                            nous permettra de vous apporter une solution d’aide à la marche adaptée à votre situation,
            ...
            sections: [
                {
                    ...
                    paragraphes: [
                        {
                            text: `Une bonne hygiène va souvent de pair avec une bonne santé.
                            Nous vous proposons   des produits de toilette  adaptés aux peaux sensibles et aux peaux vulnérables.`
                        },
                        {
                ...
                },
                {
                    ...
                    paragraphes: [
                        {
                            text: `La fuite urinaire est fréquente chez les personnes âgées,
                            mais elle existe aussi dans d’autres tranches d’âge. Particulièrement difficiles à vivre,
                            les incontinences altèrent le confort de vie des malades ainsi que leur vie sociale.`
                        },
                        {
                            text: `Nous vous proposons un choix important de protections anatomiques:
                            couches adultes, changes complets, slips absorbants, alèses etc…`
                        },
                        {
                            text: `Ces différentes alternatives permettent de retrouver une plus grande autonomie,
                            et un confort de vie au quotidien. En fonction du degré d’incontinence,
            ...
            sections: [
                {
                    paragraphes: [
                        {
                            text: `La nutrition médicale regroupe l'ensemble des aliments,
                            qui s'intègrent dans des protocoles de soins.
                            Nos gammes de produits s'adressent aux personnes âgées, aux malades, aux enfants
                            et aux patient atteints de troubles métaboliques.`
                        },
                        {
                            text: `Les aliments hypercaloriques et/ou hyperprotéinés apportent à l’organisme
                            les éléments indispensables et vont donc compléter les besoins nutritionnels du patient.
            ...
            sections: [
                {
                    ...
                    paragraphes: [
                        {
                            text: `Pour le mal de dos, nous vous conseillons d’opter pour le fauteuil releveur.
                            Conçu pour la relaxation, il soulage votre dos et vos articulations.
                ...
                },
                {
                    ...
                    paragraphes: [
                        {
                            text: `La salle de bain est un lieu délicat pour se déplacer,
                            en cas de déficit temporaire (accident de la vie courante) ou permanant.
                            Nous vous proposons différents matériels pouvant vous aider pour un confort optimal à domicile.
                            Par exemple, la barre de maintien vous permettra d’entrer et de sortir de votre baignoire ou
                ...
                },
                {
                    ...
                    paragraphes: [
                        {
                            text: `Pour votre bien-être un accès aux WC avec facilité est fortement recommandé
                            pour des personnes âgées ou à mobilité réduite.
                            Balagne Medical Services propose une gamme de rehausseurs WC qui vont permettront de surélever
        ...
        },
        {
            ...
            sections: [
                ...
                },
                {
                    ...
                    paragraphes: [
                        {
                            text: `Nous mettons à votre disposition de nombreux types d’orthèses.
                            Pour soulager vos douleurs ostéo articulaires, nous vous proposons un matériel orthopédique
                            de qualité sélectionné par nos soins auprès des meilleures marques.`
                        },
                        {
                            text: `Afin de diminuer vos problèmes de colonne vertébrale, optez pour nos ceintures
                            lombaires et abdominales, ou nos colliers cervicaux.`
                        },
                        {
                            text: `Vos articulations vous font souffrir? Nos chevillières et nos genouillères amélioreront votre confort.`
                        },
                        {
                            text: `Des problèmes veineux ? Nous vous conseillons sur le choix de bas de contention
